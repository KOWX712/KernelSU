...
fun InstallScreen() {
            ...
            val finalLkmSelection = when (lkmVariant) {
                ...
                LkmVariant.XXKSU -> {
                    ...
                    when (currentSelection) {
                        ...
                        LkmSelection.KmiNone -> LkmSelection.KmiNone
    ...
    val actions = InstallScreenActions(
        ...
        onNext = {
            val isLkmSelected = lkmSelection != LkmSelection.KmiNone || lkmVariant != LkmVariant.KOWSU
            ...
            if (!isAnyKernelMode && !isLkmSelected && (isKmiUnknown || isSelectFileMode)) {
