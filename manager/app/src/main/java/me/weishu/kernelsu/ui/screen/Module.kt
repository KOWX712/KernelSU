            ...
            when {
                viewModel.moduleList.isEmpty() -> {
                    ...
                    items(viewModel.moduleList) { module ->
                        val scope = rememberCoroutineScope()
                        val updatedModule by produceState(initialValue = ModuleViewModel.ModuleUpdateInfo.Empty, module.id, module.versionCode) {
                        ...
                        ModuleItem(
                            navigator = navigator,
                            module = module,
                            updateUrl = updatedModule.downloadUrl,
                            onUninstallClicked = {
                            ...
                            onUpdate = {
                                scope.launch {
                                    onModuleUpdate(
                                        module,
                                        updatedModule.changelog,
                                        updatedModule.downloadUrl,
                                        "${module.name}-${updatedModule.version}.zip"
                                    )
                                }
                            },
                            onClick = {
