...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appSettingsSaver = Saver<AppSettings, IntArray>(
            save = { intArrayOf(it.colorMode.value, it.keyColor, if (it.expressiveColor) 1 else 0, if (it.newColorSpec) 1 else 0) },
            restore = { AppSettings(ColorMode.fromValue(it[0]), it[1], it[2] == 1, it[3] == 1) }
        )
